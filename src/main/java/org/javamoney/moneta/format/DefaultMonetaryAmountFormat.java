...
//	 */
//	private DefaultMonetaryAmountFormat(
...
//	 * <ul>
//	 * <li>When the {@link MonetaryAmountFormat} was created using the {@link Builder}
...
//	 * </ul>
//	 * 
//	 * So, regardless if an {@link MonetaryAmountFormat} is created using the fluent
...
//	 * {@link MonetaryAmountFormat} instances programmatically using a fluent API. The
...
//		 */
//		@Override
//		public Builder appendAmount(FormatStyle style) {
...
//			FormatStyle style = new FormatStyle.Builder(locale).setRounding(
...
//
//		@Override
//		public Builder setNumberGroupCharacters(char... groupCharacters) {
//			this.groupChars = groupCharacters.clone();
//			return this;
//		}
//
//		/**
//		 * This method creates an {@link MonetaryAmountFormat} based on this instance,
...
//				appendLiteral(" ");
//				appendAmount(new FormatStyle.Builder(
//						locale).setDecimalFormat(locale)
//						.setNumberGroupChars(groupChars)
//						.setNumberGroupSizes(groupSizes).build());
//			}
//			return new DefaultMonetaryAmountFormat(tokens, defaultCurrency);
//		}
//
//		/*
//		 * (non-Javadoc)
