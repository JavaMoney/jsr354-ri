 ...
 *            The concrete type.
 */
final class DefaultCurrencyFormat implements FormatToken {
	...
	/**
	 * Creates a new {@link DefaultCurrencyFormat}.
	 * 
	 * @param style
	 ...
	 */
	public DefaultCurrencyFormat(CurrencyStyle style, Locale locale) {
		this.locale = locale;
	}
	 ...
	 */
	public DefaultCurrencyFormat setCurrencyStyle(CurrencyStyle displayType) {
		if (displayType == null) {
