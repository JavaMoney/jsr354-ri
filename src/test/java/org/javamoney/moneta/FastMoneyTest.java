...
public class FastMoneyTest {
	...
	public void testOfCurrencyUnitBigDecimal() {
		...
		assertEquals(new BigDecimal("10.00000"), m.asType(BigDecimal.class));
	}
	...
	public void testDivideToIntegralValue_BigDecimal() {
		...
		FastMoney result = money1.divideToIntegralValue(new BigDecimal(
				"0.5001"));
		assertThat(result.asType(BigDecimal.class), equalTo(new BigDecimal("1.00000")));
	}
	...
	public void testOfCurrencyUnitNumber() {
		...
		assertNotNull(m);
		assertEquals(EURO, m.getCurrency());
		assertEquals(new BigDecimal("234.23450"), m.asType(BigDecimal.class));
		m = FastMoney.of(DOLLAR, (Number) BigInteger.valueOf(232323123L));
		assertNotNull(m);
		assertEquals(DOLLAR, m.getCurrency());
		assertEquals(Long.valueOf(232323123L), m.asType(Long.class));
	...
	public void testOfStringNumber() {
		...
		assertNotNull(m);
		assertEquals(DOLLAR, m.getCurrency());
		assertEquals(Long.valueOf(21432432L), m.asType(Long.class));
	...
	/**
	 * Test method for
	 * {@link org.javamoney.moneta.FastMoney#divide(javax.money.MonetaryAmount)}.
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link org.javamoney.moneta.FastMoney#divideAndRemainder(javax.money.MonetaryAmount)}
	 * .
	 */
	@Test
	public void testDivideAndRemainderMonetaryAmount() {
		FastMoney m = FastMoney.of("CHF", 100);
		FastMoney[] res = m.divideAndRemainder(FastMoney.of("CHF", 33));
		assertEquals(FastMoney.of("CHF", 3),res[0]);
		assertEquals(FastMoney.of("CHF", 1),res[1]);
	}
	...
	/**
	 * Test method for
	 * {@link org.javamoney.moneta.FastMoney#divideToIntegralValue(javax.money.MonetaryAmount)}
	 * .
	 */
	@Test
	public void testDivideToIntegralValueMonetaryAmount() {
		...
		assertEquals(
				...
				m.divideToIntegralValue(FastMoney.of(
						"CHF",
	...
	/**
	 * Test method for
	 * {@link org.javamoney.moneta.FastMoney#multiply(javax.money.MonetaryAmount)}.
	 */
	@Test
	public void testMultiplyMonetaryAmount() {
		FastMoney m = FastMoney.of("CHF", 100);
		assertEquals(FastMoney.of("CHF", 400), m.multiply(FastMoney.of("CHF", 4)));
		assertEquals(FastMoney.of("CHF", 200), m.multiply(FastMoney.of("CHF", 2)));
		assertEquals(FastMoney.of("CHF", new BigDecimal("50.0")),
				m.multiply(FastMoney.of("CHF", 0.5)));
	}
	...
	public void testGetNumberType() {
		assertEquals(FastMoney.of("CHF", 0).getNumberType(), Long.class);
		assertEquals(FastMoney.of("CHF", 0.34738746d).getNumberType(),
				Long.class);
		assertEquals(FastMoney.of("CHF", 100034L).getNumberType(), Long.class);
	}
	...
	public void testAsTypeClassOfT() {
		...
		assertEquals(m.asType(BigDecimal.class), new BigDecimal("13.65600"));
	...
	public void testAsNumber() {
		assertEquals(new BigDecimal("0.00000"), FastMoney.of("CHF", 0).asNumber());
	...
	public void testWithMonetaryAdjuster() {
		...
		adj = new MonetaryAdjuster() {
			@Override
			public FastMoney adjustInto(MonetaryAmount amount) {
