 ...
 * the License.
 */
package org.javamoney.moneta.convert.internal.imf;
...
public class IMFRemoteSearchCallableTest {
	...
	public void shouldReturnIMFCurrencySDR() throws InterruptedException, ExecutionException {
		...
		Future<IMFRemoteSearchCallable.IMFRemoteSearchResult> resultFuture = SERVICE.submit(task);
		IMFRemoteSearchCallable.IMFRemoteSearchResult result = resultFuture.get();
