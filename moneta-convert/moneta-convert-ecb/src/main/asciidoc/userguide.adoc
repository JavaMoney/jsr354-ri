...
* _default_: this currency provider (implemented by +org.javamoney.moneta.BuildableCurrencyUnit.JDKCurrencyProvider+) simply maps/adapts +java.util.Currency+.
...
load.ECBCurrentRateProvider.resource=org/javamoney/convert/ecb/defaults/eurofxref-daily.xml
...
load.ECBHistoric90RateProvider.resource=org/javamoney/convert/ecb/defaults/eurofxref-hist-90d.xml
...
load.ECBHistoricRateProvider.resource=org/javamoney/convert/ecb/defaults/eurofxref-hist.xml
